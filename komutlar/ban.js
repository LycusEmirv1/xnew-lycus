...
exports.run = (client, message, args) => {
  ...
  if (!modlog) return message.reply('`logs` kanalını bulamıyorum.Lütfen `logs` adında bir metin kanalı oluşturun');
  ...
  if (!message.guild.member(user).bannable) return message.reply('Yetkilileri banlayamam.(Eğer yetkili değilse kişinin yetkisi benden yüksek o yüzden banlayamam)');
