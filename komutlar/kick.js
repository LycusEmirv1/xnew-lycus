...
exports.run = (client, message, args) => {
  ...
  if (!modlog) return message.reply('`logs` kanalını bulamıyorum. Lütfen logs adında bir kanal oluşturun');
  ...
  if (!message.guild.member(user).kickable) return message.reply('Yetkilileri sunucudan atamam. Eğer kişi yetkili değilse yetkimi roller kısmından üste çekin');
